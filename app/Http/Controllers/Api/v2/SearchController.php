...
use App\Http\Resources\v2\SearchCollection;
use App\Http\Resources\v2\SearchHistoryCollection;
...
class SearchController extends Controller
{
    public function suggestion(Request $request){
        ...
        // $products = filter_products($products)->get()->unique('name')->take(5);
    ...
    public function searchList(Request $request){
        ...
        if(!empty($_SERVER['HTTP_SORTINGHUBID'])){
            ...
            foreach($dataArray as $k=>$r){
                ...
                $r->links = ['details'=>$base_url."api/v2/products/".$r->id,
                      'related'=>$base_url."api/v2/products/related/".$r->id,
                      'reviews'=>$base_url."api/v2/reviews/product/".$r->id
                ];
