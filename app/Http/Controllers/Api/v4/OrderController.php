...
class OrderController extends Controller
{
    ...
    public function processOrder(Request $request)
    {
        ...
        try{
            ...
            if(isset($request->sorting_hub_id) && !empty($request->sorting_hub_id)){
                ...
                $shortId = \App\ShortingHub::whereRaw('JSON_CONTAINS(area_pincodes, \'["'.$shippingAddress->postal_code.'"]\')')->selectRaw('user_id as sorting_hub_id')->first('sorting_hub_id');
            ...
            if($request->is_grocery == 1){
                $delivery_type = $request->delivery_detail_grocery['delivery_type'];
                    if($delivery_type =="scheduled"){
                        ...
                        $delivery_time = date("H:i:s",strtotime($currentDateTime));
                    }
...

    {
        ...
        if(isset($request->sorting_hub_id) && !empty($request->sorting_hub_id)){
            ...
            $shortId = \App\ShortingHub::whereRaw('JSON_CONTAINS(area_pincodes, \'["'.$shipping_address['postal_code'].'"]\')')->selectRaw('user_id as sorting_hub_id')->first('sorting_hub_id');
            $sorting_hub_id = $shortId['sorting_hub_id'];
        }
        ...
        'grand_total' => round($requestPar['amount'],2),   
