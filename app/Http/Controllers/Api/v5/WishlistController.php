...
use App\Http\Resources\v5\WishlistCollection;
...
class WishlistController extends Controller
{
    ...
    public function products_with_peer_price($products,$shortId = NULL){
        ...
        if(isset($_SERVER['HTTP_DEVICE']) && !empty($_SERVER['HTTP_DEVICE'])){
            ...
            $cart = \App\Models\Cart::where('device_id',$device_id)->where('product_id',$product->product_id)->select('quantity','id')->first();
        ...
        $products[$key]['name'] = trans($productDetail->name);
