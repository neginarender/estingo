...
use App\Http\Resources\v3\CartCollection;
use App\Models\Cart;
        ...
        return response()->json([
            ...
            'data'=> $cartData->map(function($data){
                return [
                    ...
                    'links'=>[
                        'details'=>env('APP_URL')."api/v3/products/".$data->product_id,
                        'related'=>env('APP_URL')."api/v3/products/related/".$data->product_id
