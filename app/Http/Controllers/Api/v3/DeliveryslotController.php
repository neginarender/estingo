...
class DeliveryslotController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        foreach ($cart as $key => $cartItem){
            ...
            if( $pro->category_id == '18'|| $pro->category_id =='26' || $pro->category_id =='34' || $pro->subcategory_id == '129' || $pro->subcategory_id == '67' || $pro->category_id =='33' || $pro->category_id =='38' || $pro->category_id=='39' || $pro->category_id =='40'){
                $dairy = 1;
            }else{
                $grocery = 1;
            }
