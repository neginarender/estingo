...
class FrontEndController extends Controller
{
    ...
    public function addToCart(Request $request){
        ...
        $body['json'] = ['user_id'=>'','id'=>$request->id,'variant'=>$request->variant,'self'=>$self,'quantity'=>$quantity];
    ...
    public function genereateOrder(Request $request){
        ...
        if($response->getData()->response->success==true){
            ...
            flash("Currently, You are unable to use Cash On Delivery, Please continue with Online Payment.")->error();
            return back();
        }
