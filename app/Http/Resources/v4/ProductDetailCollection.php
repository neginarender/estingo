...
class ProductDetailCollection extends ResourceCollection
{
        ...
        return [
            'data' => $this->collection->map(function($data) {
                return [
                    ...
                    'sub_category' => [
                        'name' => $data->subCategory != null ? trans($data->subCategory->name) : null,
                        'links' => [
                    ...
                    'in_subscribed'=> $this->checkInSubscribed($data->id),
                    'subscribed_by_user' => $this->checkALreadySubscribed($data->id)
                ];
            })
        ];
    }
    ...
    public function checkInSubscribed($product_id){
        if(!empty($_SERVER['HTTP_SORTINGHUBID'])){
            ...
            if($productM != NULL){
                $recurring_status = $productM['recurring_status'];
