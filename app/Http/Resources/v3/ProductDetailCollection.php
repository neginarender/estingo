            ...
            'data' => $this->collection->map(function($data) {
                return [
                    ...
                    'category' => [
                        ...
                        'links' => [
                            'products' => route('apiv3.products.category', $data->category_id),
                            'sub_categories' => route('v3.subCategories.index', $data->category_id)
                        ]
                    ],
                    'sub_category' => [
                        'name' => $data->subCategory != null ? $data->subCategory->name : null,
                        'links' => [
                            'products' => $data->subCategory != null ? route('apiv3.products.subCategory', $data->subcategory_id) : null
                        ]
                    ],
                    'brand' => [
                        ...
                        'links' => [
                            'products' => $data->brand != null ? route('apiv3.products.brand', $data->brand_id) : null
                        ]
                    ],
                    ...
                    'links' => [
                        'reviews' => route('apiv3.reviews.index', $data->id),
                        'related' => route('apiv3.products.related', $data->id),
