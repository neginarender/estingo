        ...
        return [
            'data' => $this->collection->map(function($data) {
                return [
                    ...
                    'max_purchase_qty'=>maxPurchaseQty($data->id,$_SERVER['HTTP_SORTINGHUBID']),
                    ...
                    'category' => [
                        ...
                        'links' => [
                            'products' => route('apiv5.products.category', $data->category_id),
                            'sub_categories' => route('apiv5.subCategories.index', $data->category_id)
                        ]
                    ],
                    'sub_category' => [
                        'name' => $data->subCategory != null ? $data->subCategory->name : null,
                        'links' => [
                            'products' => $data->subCategory != null ? route('apiv5.products.subCategory', $data->subcategory_id) : null
                        ]
                    ],
                    'brand' => [
                        ...
                        'links' => [
                            'products' => $data->brand != null ? route('apiv5.products.brand', $data->brand_id) : null
                        ]
                    ],
                    ...
                    'links' => [
                        'reviews' => route('apiv5.reviews.index', $data->id),
                        'related' => route('apiv5.products.related', $data->id),
