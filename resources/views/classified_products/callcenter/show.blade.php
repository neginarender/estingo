    ...
    <div class="panel">
        <div class="panel-body">
            ...
            @if(Auth::user()['user_type'] == "operations")
             ...
             @else
                    <a href="{{ route('callceter.add_to_order',['id'=>$order->id]) }}" class="btn btn-success">+ Add products</a>
                    @endif
            @endif
...
<!-- Modal cancel -->
    <div id="myModalCancel" class="modal fade" data-backdrop="static" data-keyboard="false" role="dialog">
    <div class="modal-dialog">
        ...
        @csrf
            ...
            <div class="form-group">
                ...
                <div class="col-lg-7">
                    ...
                    <input type="number" placeholder="Mobile" name="mobilenum" class="form-control get_mobile" autocomplete="off" id="getmobile" required><br>
...
@section('script')
    ...
    $.post('{{ route('callceter.cancelorder') }}',{_token:'{{ csrf_token() }}', mobile:mobile}, function(data){
        // console.log(data);
       if(data==1){
            $('.show_verified').show();
            $('.otp_module').show();
...
$(".get_otp").blur(function(){
    ...
    $.post('{{ route('callceter.getcancel_otp') }}',{_token:'{{ csrf_token() }}', mobile:mobile, otp:otp, order_id:order_id}, function(data){
       if(data==1){
