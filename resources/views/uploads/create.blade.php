<div class="panel">
    <div class="panel-heading">
        <h3 class="panel-title">{{translate('Upload To Emailer')}}</h3>
    </div>
    ...
    <form class="form-horizontal" action="{{ route('uploads.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="panel-body">
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" id="title" name="title" placeholder="{{ translate('Title') }}" class="form-control" required>
                </div>
            </div>
            <div class="form-group">
                <div class="col-sm-3">
...
<script type="text/javascript">
    $(document).ready(function(){
        $("#uploadphotos").spartanMultiImagePicker({
            fieldName:        'photos[]',
            maxCount:         1,
            rowHeight:        '200px',
