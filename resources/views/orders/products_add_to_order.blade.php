@if(count($products) > 0)
    <div class="col-sm-12">
        ...
        <table class="table table-bordered" id="create_session">
    		<thead>
    			<tr>
                    <td class="" width="10%">
                    ...
                    <td class="text-center">
                        <label for="" class="control-label">{{translate('Add to order')}}</label>
                    </td>
    		...
    		<tbody>
                ...
                @endphp 
                		<tr>
                			...
                			<td align="center">
                				<input type="checkbox" class="form-control selectedId" name="products[]" value="{{$product->id}}" style="width: 16px;" price = {{$variant_price}} >
                			</td>
