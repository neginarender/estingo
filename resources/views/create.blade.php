		...
		<form class="form form-horizontal mar-top" action="{{route('products.store')}}" method="POST" enctype="multipart/form-data" id="choice_form">
			...
			<div class="panel">
				...
				<div class="panel-body">
					...
					<div class="form-group">
						<label class="col-lg-2 control-label">{{translate('Sellers')}}</label>
						<div class="col-lg-7">
...
function get_seller_id(){
		...
		$.post('{{ route('sellers.get_seller_id') }}',{_token:'{{ csrf_token() }}', seller_id:seller_id}, function(data){
		    $('#      ').html(null);
		    for (var i = 0; i < data.length; i++) {
