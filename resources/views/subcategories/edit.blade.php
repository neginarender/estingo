    ...
    <div class="panel">
        ...
        <form class="form-horizontal" action="{{ route('subcategories.update', $subcategory->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label">{{translate('Tags')}}</label>
                    <div class="col-sm-9">
                    <input type="text" class="form-control" name="tags[]" id="tags" value="{{ $subcategory->tags }}" placeholder="{{ translate('Type to add a tag') }}" data-role="tagsinput">
                    </div>
                </div>
                <div class="form-group">
