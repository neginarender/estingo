    ...
    <div id="navbar-container" class="boxed">
        ...
        <div class="navbar-header">
            ...
            @elseif( auth()->user()->user_type == 'fieldofficer')
              <a href="{{route('callceter.fieldofficer')}}" class="navbar-brand">
                @if($generalsetting->logo != null)
                    <img loading="lazy"  src="{{ my_asset($generalsetting->admin_logo) }}" class="brand-icon" alt="{{ $generalsetting->site_name }}">
                @else
                    <img loading="lazy"  src="{{ my_asset('img/logo_shop.png') }}" class="brand-icon" alt="{{ $generalsetting->site_name }}">
              ...
              <a href="{{route('callceter.callcetertbl')}}" class="navbar-brand">
                @if($generalsetting->logo != null)
                    <img loading="lazy"  src="{{ my_asset($generalsetting->admin_logo) }}" class="brand-icon" alt="{{ $generalsetting->site_name }}">
                @else
                    <img loading="lazy"  src="{{ my_asset('img/logo_shop.png') }}" class="brand-icon" alt="{{ $generalsetting->site_name }}">
              ...
              <a href="{{route('callceter.orderspration')}}" class="navbar-brand">
                @if($generalsetting->logo != null)
                    <img loading="lazy"  src="{{ my_asset($generalsetting->admin_logo) }}" class="brand-icon" alt="{{ $generalsetting->site_name }}">
                @else
                    <img loading="lazy"  src="{{ my_asset('img/logo_shop.png') }}" class="brand-icon" alt="{{ $generalsetting->site_name }}">
              ...
              @elseif( auth()->user()->user_type == 'productlisting')
              <a href="{{route('callceter.brandsps')}}" class="navbar-brand">
                @if($generalsetting->logo != null)
                    <img loading="lazy"  src="{{ my_asset($generalsetting->admin_logo) }}" class="brand-icon" alt="{{ $generalsetting->site_name }}">
                @else
                    <img loading="lazy"  src="{{ my_asset('img/logo_shop.png') }}" class="brand-icon" alt="{{ $generalsetting->site_name }}">
             ...
             @elseif(in_array('20', json_decode(Auth::user()->staff->role->permissions)))
              <a href="{{route('admin.dashboard')}}" class="navbar-brand">
                @if($generalsetting->logo != null)
                    <img loading="lazy"  src="{{ my_asset($generalsetting->admin_logo) }}" class="brand-icon" alt="{{ $generalsetting->site_name }}">
                @else
