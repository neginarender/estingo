...
@section('content')
<div>
    <h1 class="page-header text-overflow">{{ translate('Add New Sorting Manager') }}</h1>
</div>
<div class="row">
	<div class="col-lg-8 col-lg-offset-2">
		<form class="form form-horizontal mar-top" action="{{route('sortingmanager.store')}}" method="POST" enctype="multipart/form-data" id="choice_form">
			@csrf
			<div class="panel">
				...
				<div class="panel-body">
					...
					<div class="form-group">
						...
						<div class="col-lg-7">
							<input type="text" class="form-control" name="name" placeholder="{{ translate('Manager Name') }}" required>
						</div>
					</div>
