...
@section('content')
    ...
    <div class="tab-base">
        ...
        <ul class="nav nav-tabs">
            ...
            <li class="">
                <a data-toggle="tab" href="#demo-lft-tab-6" aria-expanded="false">{{ translate('Banner Slider') }}</a>
            </li>
            <li class="">
                <a data-toggle="tab" href="#demo-lft-tab-7" aria-expanded="false">{{ translate('Finance Banner') }}</a>
            </li>
            <li class="">
                <a data-toggle="tab" href="#demo-lft-tab-8" aria-expanded="false">{{ translate('Master Banner') }}</a>
            </li>
            <li class="">
            ...
            <li class="">
                <a data-toggle="tab" href="#demo-lft-tab-9" aria-expanded="false">{{ translate('Service Not Available') }}</a>
            </li>
            <li class="">
                <a data-toggle="tab" href="#demo-lft-tab-10" aria-expanded="false">{{ translate('Upload To Emailer') }}</a>
            </li>
        </ul>
        ...
        <div id="demo-lft-tab-8" class="tab-pane fade">
            <div class="row">
                <div class="col-sm-12">
                    <a onclick="add_master_banner()" class="btn btn-rounded btn-info pull-right">{{translate('Add New Banner')}}</a>
                </div>
            </div>
            <br>
            <div class="panel">
                <div class="panel-heading">
                    <h3 class="panel-title">{{translate('Master banner')}} ({{translate('Max 3 published')}})</h3>
                </div>
                <div class="panel-body">
                    <table class="table table-striped table-bordered demo-dt-basic" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            @foreach(\App\MasterBanner::all() as $key => $banner)
                                <tr>
                                    <td>{{$key+1}}</td>
                                    <td><img loading="lazy"  class="img-md" src="{{ my_asset($banner->photo)}}" alt="banner Image"></td>
                                    <td>{{ $banner->link }}</td>
                                    <td><label class="switch">
                                        <input onchange="update_master_banner_status(this)" value="{{ $banner->id }}" type="checkbox" <?php if($banner->published == 1) echo "checked";?> >
                                    ...
                                    <td>
                                        <div class="btn-group dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-right">
                                                <li><a onclick="edit_master_banner({{ $banner->id }})">{{translate('Edit')}}</a></li>
                                                <!-- <li><a onclick="confirm_modal('{{route('master_banners.destroy', $banner->id)}}');">{{translate('Delete')}}</a></li> -->
                                            </ul>
                                        </div>
                                    </td>
                                </tr>
        ...
        <div id="demo-lft-tab-7" class="tab-pane fade">
            <div class="row">
                <div class="col-sm-12">
                    <a onclick="add_finance_banner()" class="btn btn-rounded btn-info pull-right">{{translate('Add New Banner')}}</a>
                </div>
            </div>
            <br>
            <div class="panel">
                <div class="panel-heading">
                    <h3 class="panel-title">{{translate('Finance banner')}} ({{translate('Max 4 published')}})</h3>
                </div>
                <div class="panel-body">
                    <table class="table table-striped table-bordered demo-dt-basic" cellspacing="0" width="100%">
                        <thead>
                        ...
                        <tbody>
                            @foreach(\App\FinanceBanner::all() as $key => $banner)
                                <tr>
                                    <td>{{$key+1}}</td>
                                    <td><img loading="lazy"  class="img-md" src="{{ my_asset($banner->photo)}}" alt="banner Image"></td>
                                    <td>{{ translate('Banner Position ') }}{{ $banner->position }}</td>
                                    <td><label class="switch">
                                        <input onchange="update_finance_banner_status(this)" value="{{ $banner->id }}" type="checkbox" <?php if($banner->published == 1) echo "checked";?> >
                                        <span class="slider round"></span></label></td>
                                    <td>
                                        <div class="btn-group dropdown">
                                            <button class="btn btn-primary dropdown-toggle dropdown-toggle-icon" data-toggle="dropdown" type="button">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-right">
                                                <li><a onclick="edit_finance_banner({{ $banner->id }})">{{translate('Edit')}}</a></li>
                                                <!-- <li><a onclick="confirm_modal('{{route('finance_banner.destroy', $banner->id)}}');">{{translate('Delete')}}</a></li> -->
                                            </ul>
                                        </div>
                                    </td>
                                </tr>
         ...
         <div id="demo-lft-tab-6" class="tab-pane fade">
                <div class="row">
                    <div class="col-sm-12">
                        <a onclick="add_banner_slider()" class="btn btn-rounded btn-info pull-right">{{translate('Add New Banner')}}</a>
                    </div>
                </div>
                <br>
                <div class="panel">
                    <div class="panel-heading">
                        <h3 class="panel-title">{{translate('Banner slider')}}</h3>
                    </div>
                    <div class="panel-body">
                        <table class="table table-striped table-bordered demo-dt-basic" cellspacing="0" width="100%">
                            <thead>
                            ...
                            <tbody>
                                @foreach(\App\BannerSlider::all() as $key => $slider)
                                    <tr>
                                        <td>{{$key+1}}</td>
                                        <td><img loading="lazy"  class="img-md" src="{{ my_asset($slider->photo)}}" alt="Slider Image"></td>
                                        <td>{{$slider->link}}</td>
                                        <td><label class="switch">
                                            <input onchange="update_banner_slider_status(this)" value="{{ $slider->id }}" type="checkbox" <?php if($slider->published == 1) echo "checked";?> >
                                            <span class="slider round"></span></label></td>
                                        <td>
                                            <div class="btn-group dropdown">
                                                <button class="btn btn-primary dropdown-toggle dropdown-toggle-icon" data-toggle="dropdown" type="button">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                     <li><a onclick="edit_banner_slider({{ $slider->id }})">{{translate('Edit')}}</a></li>
                                                    <!-- <li><a onclick="confirm_modal('{{route('banner_sliders.destroy', $slider->id)}}');">{{translate('Delete')}}</a></li> -->
                                                </ul>
                                            </div>
                                        </td>
                                    </tr>
                        ...
                        <table class="table table-striped table-bordered demo-dt-basic" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>{{translate('Photo')}}</th>
                                    <th>{{translate('Mobile View Photo')}}</th>
                                    <th width="50%">{{translate('Link')}}</th>
                                    <th>{{translate('Published')}}</th>
                                    <th width="10%">{{translate('Options')}}</th>
                                </tr>
                            ...
                            <tbody>
                                @foreach(\App\Slider::all() as $key => $slider)
                                    <tr>
                                        <td>{{$key+1}}</td>
                                        <td><img loading="lazy"  class="img-md" src="{{ my_asset($slider->photo)}}" alt="Slider Image"></td>
                                        <td><img loading="lazy"  class="img-md" src="{{ my_asset($slider->mobile_photo)}}" alt="Slider Image"></td>
                                        <td>{{$slider->link}}</td>
                                        <td><label class="switch">
                                            <input onchange="update_slider_status(this)" value="{{ $slider->id }}" type="checkbox" <?php if($slider->published == 1) echo "checked";?> >
                                            <span class="slider round"></span></label></td>
                                        <td>
                                            <div class="btn-group dropdown">
                                                <button class="btn btn-primary dropdown-toggle dropdown-toggle-icon" data-toggle="dropdown" type="button">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a onclick="edit_slider('{{ $slider->id }}');">{{translate('Edit')}}</a></li>
                            ...
                            <tbody>
                                @foreach(\App\Banner::where('position', 1)->get() as $key => $banner)
                                    <tr>
                                        ...
                                        <td>{{ translate('Banner Position ') }}{{ $banner->position }}</td>
                                        <td><label class="switch">
                                            <input onchange="update_banner_status(this)" value="{{ $banner->id }}" type="checkbox" <?php if($banner->published == 1) echo "checked";?> >
                                            <span class="slider round"></span></label></td>
                                        <td>
                                            <div class="btn-group dropdown">
                                                <button class="btn btn-primary dropdown-toggle dropdown-toggle-icon" data-toggle="dropdown" type="button">
            ...
            <div id="demo-lft-tab-9" class="tab-pane fade">
                <div class="row">
                    <div class="col-sm-12">
                        <a onclick="add_service_banner()" class="btn btn-rounded btn-info pull-right">{{translate('Add Service Banner')}}</a>
                    </div>
                </div>
                <br>
                <div class="panel">
                    <div class="panel-heading">
                        <h3 class="panel-title">{{translate('Service Banner')}}</h3>
                    </div>
                    <div class="panel-body">
                        <table class="table table-striped table-bordered demo-dt-basic" cellspacing="0" width="100%">
                            <thead>
                            ...
                            <tbody>
                                @foreach(\App\ServiceBanner::all() as $key => $slider)
                                    <tr>
                                        <td>{{$key+1}}</td>
                                        <td><img loading="lazy"  class="img-md" src="{{ my_asset($slider->photo)}}" alt="Slider Image"></td>
                                        <td>{{$slider->link}}</td>
            ...
            <div id="demo-lft-tab-10" class="tab-pane fade">
                <div class="row">
                    <div class="col-sm-12">
                        <a onclick="add_to_emailer()" class="btn btn-rounded btn-info pull-right">{{translate('Upload Photo')}}</a>
                    </div>
                </div>
                <br>
                <div class="panel">
                    <div class="panel-heading">
                        <h3 class="panel-title">{{translate('Uploads')}}</h3>
                    </div>
                    <div class="panel-body">
                        <table class="table table-striped table-bordered demo-dt-basic" cellspacing="0" width="100%">
                            <thead>
                            ...
                            <tbody>
                                @foreach(\App\Upload::all() as $key => $upload)
                                    <tr>
                                        <td>{{$key+1}}</td>
                                        <td><img loading="lazy"  class="img-md" src="{{ my_asset($upload->photo)}}" alt="Slider Image"></td>
                                        <td>{{ $upload->title }}</td>
                                        <td>{{ my_asset($upload->photo)}}</td>
                                        <!-- <td><label class="switch">
                                            <input onchange="update_banner_slider_status(this)" value="{{ $slider->id }}" type="checkbox" <?php if($slider->published == 1) echo "checked";?> >
                                            <span class="slider round"></span></label></td>-->
                                        <td> 
                                            <div class="btn-group dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                     <!-- <li><a onclick="edit_banner_slider({{ $slider->id }})">{{translate('Edit')}}</a></li> -->
                                                    <li><a onclick="confirm_modal('{{route('uploads.destroy', $upload->id)}}');">{{translate('Delete')}}</a></li>
                                                </ul>
                                            </div>
                                        </td>
                                    </tr>
...
<script type="text/javascript">
    ...
    function add_banner_slider(){
        $.get('{{ route('banner_sliders.create')}}', {}, function(data){
            $('#demo-lft-tab-6').html(data);
        });
    }

    function add_service_banner(){
        $.get('{{ route('serviceNotAvailable.create')}}', {}, function(data){
            $('#demo-lft-tab-9').html(data);
        });
    }

    function add_to_emailer(){
        $.get('{{ route('uploads.create')}}', {}, function(data){
            
            $('#demo-lft-tab-10').html(data);
        });
    }

    function add_master_banner(){
        $.get('{{ route('master_banners.create')}}', {}, function(data){
            $('#demo-lft-tab-8').html(data);
        });
    }

    function add_finance_banner(){
        $.get('{{ route('finance_banner.create')}}', {}, function(data){
    ...
    function edit_finance_banner(id){
        var url = '{{ route("finance_banner.edit", "home_banner_id") }}';
        url = url.replace('home_banner_id', id);
        $.get(url, {}, function(data){
            $('#demo-lft-tab-7').html(data);
            $('.demo-select2-placeholder').select2();
    ...
    function edit_banner_slider(id){
        var url = '{{ route("banner_sliders.edit", "home_banner_id") }}';
        url = url.replace('home_banner_id', id);
        $.get(url, {}, function(data){
            $('#demo-lft-tab-6').html(data);
            $('.demo-select2-placeholder').select2();
    ...
    function edit_master_banner(id){
        var url = '{{ route("master_banners.edit", "home_banner_id") }}';
        url = url.replace('home_banner_id', id);
        $.get(url, {}, function(data){
            $('#demo-lft-tab-8').html(data);
            $('.demo-select2-placeholder').select2();
    ...
    function update_finance_banner_status(el){
        if(el.checked){
            var status = 1;
        }
        else{
        ...
        $.post('{{ route('finance_banner.update_status') }}', {_token:'{{ csrf_token() }}', id:el.value, status:status}, function(data){
            if(data == 1){
                showAlert('success', 'Banner status updated successfully');
            }
            else{
    ...
    function update_banner_slider_status(el){
        ...
        $.post('{{ route('banner_sliders.update_status') }}', {_token:'{{ csrf_token() }}', id:el.value, status:status}, function(data){
            if(data == 1){
                showAlert('success', 'Banner status updated successfully');
            }
            else{
    ...
    function update_master_banner_status(el){
        ...
        $.post('{{ route('master_banners.update_status') }}', {_token:'{{ csrf_token() }}', id:el.value, status:status}, function(data){
            if(data == 1){
                showAlert('success', 'Banner status updated successfully');
            }
            else{
