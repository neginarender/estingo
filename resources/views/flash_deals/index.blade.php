...
<div class="row">
    <div class="col-sm-12">
        ...
        <a href="{{ route('admin.flash_deal.product_list')}}" class="btn btn-success btn-rounded btn-info pull-right">{{translate('Deal products list')}}</a>
    </div>
</div>
            ...
            <tbody>
                @foreach($flash_deals as $key => $flash_deal)
                    ...
                    <tr>
                        ...
                        <td>{{ \App\User::findOrFail($flash_deal->sorting_hub_id)->name }}</td>
