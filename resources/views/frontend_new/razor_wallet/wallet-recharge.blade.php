    ...
    "theme": {
     ...
     "modal": {
        ...
        "ondismiss": function(){
            ...
            window.location.href = "https://rozana.in/rozana_uat/checkout/payment_select";
...
<form action="{!!route('phoneapi.walletrecharge-success')!!}" method="POST" hidden>
        ...
        <input type="hidden" class="form-control"  name="entity" value="{{$response['entity']}}">
        <input type="hidden" class="form-control"  name="amount" value="{{$response['amount']}}">
        <input type="hidden" class="form-control"  name="currency" value="{{$response['currency']}}">
        <input type="hidden" class="form-control"  name="receipt" value="{{$response['receipt']}}">
        <input type="hidden" class="form-control"  name="status" value="{{$response['status']}}">
        <input type="hidden" class="form-control"  name="attempts" value="{{$response['attempts']}}">
        <input type="hidden" class="form-control"  name="amount" value="{{$response['amount']}}">
        <input type="hidden" class="form-control"  name="payment_method" value="{{$response['payment_method']}}">
        <input type="hidden" class="form-control"  name="payment_type" value="{{$response['payment_type']}}">

        <input type="text" class="form-control" id="rzp_signature" name="rzp_signature">
        <input type="text" class="form-control" id="order_code" name="order_code" value="{{$response['receipt']}}" />
        <input type="text" class="form-control" id="order_code" name="referal_code" value="{{$referal_code}}" />
