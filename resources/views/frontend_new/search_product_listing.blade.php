                  ...
                  <div class="row">
                    ...
                    <div class="col-xl-12">
                        <div class="sort-by-bar row no-gutters   px-3 pt-2">
                            <div class="col-xl-6 ">
                                  <div class="d-block w-100" style="margin-bottom:22px;">  
                                    <!-- <ul class="breadcrumb  ">
                                       <li><a href="index.html">Home</a></li>
                                       <li><a href="categories.html">All Categories</a></li>
                                         <li class="active"><a href="#">Grocery &amp; Staple</a></li>
                                   </ul> -->
                                   <span style="font-size:20px;">Search results for <strong style="color:red;">{{ucfirst(request('q'))}}</strong></span>
                               </div>
                           ...
                           <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-2 col-6  ">
                              <div class="product-card-2 shop-cards mx-0 bg-white alt-box my-2 ">
                                ...
                                <form id="product_form{{ $cid }}">
                                    ...
                                    <input type="hidden" id="max_purchase_qty{{$cid}}" name="max_purchase_qty" value="100"> 
                                </form>
                                @php 
                                $sortinghubid = "";
                                if(Cookie::has('sid')){
                                ...
                                $cprice = calculatePrice($product->product_id,$sortinghubid,1);
                                //dd($cprice);
