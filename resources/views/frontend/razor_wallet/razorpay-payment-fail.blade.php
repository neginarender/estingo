                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="text-center py-4 border-bottom mb-4">
                                    <i class="la la la-times-circle-o la-3x text-danger mb-3"></i>
                                    @if($banned==1)
                                    <h1 class="h3 mb-3">{{ translate('We found a suspicious  activity. Your account is blocked, kindly contact  Rozana Helpdesk at customercare@rozana.in.')}}</h1>
                                    @endif
                                    
                                    <h2 class="h5 strong-700">{{ translate($reason)}}</h2>
