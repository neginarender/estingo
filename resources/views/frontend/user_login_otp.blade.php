                        ...
                        <div class="card">
                            <div class="text-center px-35 pt-5">
                                <h1 class="heading heading-4 strong-500">
                                    {{ translate('Login to your account with phone.')}}
                                </h1>
                            </div>
                                ...
                                <div class="">
                                    <form class="form-default" role="form" action="{{ route('user.login_phone') }}" method="POST">
                                        ...
                                        <div class="form-group">
                                                ...
                                                <input type="text" class="form-control h-auto form-control-lg {{ $errors->has('phone') ? ' is-invalid' : '' }}" value="{{ old('phone') }}" placeholder="{{  translate('Phone') }}" name="phone">
                                            @if ($errors->has('phone'))
