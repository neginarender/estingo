...
<style type="text/css">
     ...
     .pass a{position: absolute; right: 10px; top: 15px; font-size: 15px}

   /* .nav-search-box {margin-top: -6px}
     .referral .btn {bottom:8px }
    .referral {height: 30px; padding-top: 5px;}
     @media (max-width: 800px){
       .search-box-mob .search .nav-search-box {  margin-top: -5px; margin-bottom: 5px}
        .referral {top: 0px}
        .referral .btn { bottom: 17px;}
        .sm-fixed-top { top: -135px !important;}
    }*/
</style>
                    ...
                    <div class="col-xxl-4 col-xl-5 col-lg-6 col-md-8 mx-auto">
                        <div class="card">
                            ...
                            <div class="px-5 py-3 py-lg-4">
                                <div class="">
                                    <form id="reg-form" class="form-default" role="form" action="{{ route('user.register_phone') }}" method="POST">
                                        @csrf
                                        ...
                                        @else
                                         <div class="form-group">
                                                <input type="text" class="h-auto form-control-lg form-control{{ $errors->has('phone') ? ' is-invalid' : '' }}" value="{{ old('phone') }}" placeholder="{{  translate('Phone') }}" name="phone">
                                                @if ($errors->has('phone'))
                                                    <span class="invalid-feedback" role="alert">
 ...
 -->                                        @endif
                                        ...
                                        <div class="checkbox text-left">
                                            ...
                                            <label for="checkboxExample_1a" class="text-sm">{{ translate('By signing up you agree to our')}} <a href="{{ url('/') }}/terms" target="_blank">terms and conditions</a></label>
                                        </div>
