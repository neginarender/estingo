                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    <div class="row gutters-10">
                                        ...
                                        <a href= "{{route('show.map',[encrypt(2)])}}">
                ...
                <form class="form-default" role="form" action="{{ route('addresses.store') }}" method="POST" autocomplete="on">
                    ...
                    <div class="modal-body product-choose loc_form">
                        <div class="">
                            <div class="row">
                                <div class="col-md-6">
                                    <label>{{ translate('Address Format') }}</label>
                                    <input id="map-search" class="form-control controls" type="text" placeholder="Search Box"  required="" >
                                </div>
                                ...
                                <div class="col-md-3 col-sm-6 col-6">
                                     <label>{{ translate('City')}}</label>
                                      <input type="text" class="reg-input-city form-control" placeholder="City" required="">
                                  </div>
                                  <div class="col-md-3 col-sm-6 col-6">
                                     <label>{{ translate('State')}}</label>
                                      <input type="text" class="reg-input-state form-control" placeholder="State" required="">
                                  </div>
                                   <input type="hidden" class="reg-input-country form-control">
                                  <div class="col-md-3 col-sm-6 col-6">
                                     <label>{{ translate('Postal')}}</label>
                                      <input type="text" class="reg-input-postal form-control" placeholder="postal code" required="">
                                  </div>
