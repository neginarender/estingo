        ...
        <div class="container">
            <div class="row cols-xs-space cols-sm-space cols-md-space">
                ...
                @if(Auth::user()->user_type == 'seller')
                    ...
                    @elseif(Auth::user()->user_type == 'customer' ||Auth::user()->user_type == 'partner')
                      ...
                      @if (Auth::user()->id != null)
                          <div class="card no-border mt-5">
                            <div class="card-header py-3">
                                <h4 class="mb-0 h6">{{ translate('Peer Wallet History')}}
                                   </h4>
                            </div>
                                                ...
                                                <td>
                                                    <div class="btn-group dropdown">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-right">
                                                            ...
                                                            <li><a href="{{ route('wallet_customer_subpeer_commissions.show', encrypt($order_id->user_id.'_'.$row->partner_id)) }}" target="blank">{{translate('View Customer Peer Report')}}</a></li>                                         
