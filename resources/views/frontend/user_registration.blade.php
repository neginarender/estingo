    ...
    .referral {height: 30px; padding-top: 5px;}*/
     @media (max-width: 800px){
      /*  .search-box-mob .search .nav-search-box {  margin-top: -5px; margin-bottom: 5px}
        ...
        .sm-fixed-top { top: -130px !important;}*/
    }
</style>
                                ...
                                <div class="">
                                    <form id="reg-form" class="form-default" role="form" action="{{ route('register') }}" method="POST">
                                        ...
                                        <div class="checkbox text-left">
                                            ...
                                            <label for="checkboxExample_1a" class="text-sm">{{ translate('By signing up you agree to our') }} <a href="{{ url('/')}}/terms" target="_blank">{{ translate('terms and conditions.') }}</a></label>
                                        </div>
