                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="row">
                          ...
                          <div class="row">
                            <div class="col-sm-10">
                                <label class="control-label">{{ translate('Peer Partner') }}</label>
                            </div>
                            <div class="col-sm-2">
                                <label class="switch">
                        ...
                        <div class="row">
                            <div class="col-sm-10">
                                <label class="control-label">{{ translate('Cluster Hub') }}</label>
                            </div>
                            <div class="col-sm-2">
                                <label class="switch">
                        ...
                        <div class="row">
                            <div class="col-sm-10">
                                <label class="control-label">{{ translate('Sorting Hub') }}</label>
                            </div>
                            <div class="col-sm-2">
                                <label class="switch">
                                    <input type="checkbox" name="permissions[]" class="form-control demo-sw" value="23" @php if(in_array(21, $permissions)) echo "checked"; @endphp>
                                    <span class="slider round"></span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-10">
                                <label class="control-label">{{ translate('Create Mapping') }}</label>
                            </div>
                            <div class="col-sm-2">
                                <label class="switch">
                        ...
                        <div class="row">
                            <div class="col-sm-10">
                                <label class="control-label">{{ translate('Mapping Products') }}</label>
                            </div>
                            <div class="col-sm-2">
                                <label class="switch">
...
`
                        <div class="row">
                            <div class="col-sm-10">
                                <label class="control-label">{{ translate('Distributor') }}</label>
                            </div>
                            <div class="col-sm-2">
                                <label class="switch">
                        ...
                        <div class="row">
                            <div class="col-sm-10">
                                <label class="control-label">{{ translate('Your Orders') }}</label>
                            </div>
                            <div class="col-sm-2">
                                <label class="switch">
                        ...
                        <div class="row">
                            <div class="col-sm-10">
                                <label class="control-label">{{ translate('Master Peer') }}</label>
                            </div>
                            <div class="col-sm-2">
                                <label class="switch">
