			...
			<div class="panel">
				...
				<div class="panel-body">
					<!-- <div class="form-group">
						<label class="col-lg-2 control-label">{{translate('Managed By')}}</label>
						<div class="col-lg-7">
							<select class="form-control demo-select2-placeholder" name="manage_type_id" id="managed_id" required>
								<option value="">Select an option</option>
								<option value="0" <?php if($product->manage_by == 0){ echo "selected"; } ?> >Ecom</option>
								<option value="1" <?php if($product->manage_by == 1){ echo "selected"; } ?>>Ekhadi</option>
							</select>
						</div>
					</div>

					<div class="form-group">
						<label class="col-lg-2 control-label">Sellers</label>
						<div class="col-lg-7">
							<select class="form-control demo-select2-placeholder" name="seller_id" id="seller_id" required>								
							</select>
						</div>
					</div> -->
					<div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-7">
                            <input type="text" class="form-control" name="unit" placeholder="{{ translate('Unit (e.g. KG, Pc etc)') }}" value="{{$product->unit}}">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-7">
                            <input type="text" class="form-control" id="tags" name="tags[]" id="tags" value="{{ $product->tags }}" placeholder="{{ translate('Type to add a tag') }}" data-role="tagsinput">
                        </div>
                        <button id="meta_tags" title="Copy meta tags" type="button"><i class="fa fa-copy"></i></button>
							<div id="copy_meta_tags"></div>
                    </div>
					<div class="form-group">
                        <label class="col-lg-2 control-label">{{translate('Json Tags')}}</label>
                        <div class="col-lg-7">
					
                            <input type="text" class="form-control" id="json_tags" name="jsontags[]" id="tags" value="@if(!empty($product->json_tags)){{implode(',',json_decode($product->json_tags))}} @endif" placeholder="{{ translate('Type to add a tag') }}" data-role="tagsinput">
                        </div>
                        <button id="copy" type="button" title="Copy json tags"><i class="fa fa-copy"></i></button></button>
							<div id="copy_tags"></div>
                    </div>

					<!-- <div class="form-group">
						<label class="col-lg-2 control-label">Gift Card ?</label>
						<div class="col-lg-7">
							<input type="checkbox" name="gift_card" value="1" @if($product->gift_card) checked @endif>
						</div>
					</div> -->
					...
					<div class="customer_choice_options" id="customer_choice_options">
						...
						?>
							<div class="form-group">
								...
								<div class="col-lg-7">																					
								<select onchange="check_valoption({{$choice_option->attribute_id}})" id="choice_opt_{{$choice_option->attribute_id}}" class="form-control demo-select2" multiple data-placeholder="{{ translate('Choose Attributes') }}">								
								<?php
									$optionattributes = getListById($choice_option->attribute_id);
									foreach($optionattributes as $key => $value)
									{
										$current_option = $choice_option->values;									
										if(strpos($current_option[0], "|") !== false){
											$main_array = explode("|",$current_option[0]);
										} else{
											$main_array = $current_option;
										}
										?>
										<option value="<?php echo $value->attribute_option_value;?>" <?php if(in_array($value->attribute_option_value, $main_array)){echo "selected";}?>><?php echo $value->attribute_option_value?></option>
										<?php										
									}
								?>																	
	                        	</select>
									<input style="display:none;" type="text" class="form-control" name="choice_options_{{ $choice_option->attribute_id }}[]" id="opt_val_{{ $choice_option->attribute_id }}" placeholder="{{ translate('Enter choice values') }}" value="{{ implode(',', $choice_option->values) }}" data-role="tagsinput" onchange="update_sku()">
								</div>
								<div class="col-lg-2">
			...
			<div class="panel">
				...
				<div class="panel-body">
					{{-- <div class="form-group">
                        ...
                        <div class="col-lg-7">
                            <input type="text" placeholder="{{translate('Unit price')}}" name="unit_price" class="form-control" value="{{$product->unit_price}}" min="0.01" required>
                        </div>
                    </div> --}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-7">
                            <input type="number" min="0" step="0.01" placeholder="{{translate('Purchase price')}}" name="purchase_price" class="form-control" value="{{$product->purchase_price}}" min="0.01" required>
                        </div>
                    </div>
                    <div class="form-group">
...
<script type="text/javascript">
	...
	function check_valoption(i){
		
		$(this).change(function(){ 			
			var selectedValues = $('#choice_opt_'+i).val();	
			$("#opt_val_"+i).val(selectedValues);
			update_sku();                                                                                                                  
		});
	}
