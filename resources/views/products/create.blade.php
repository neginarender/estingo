			...
			<div class="panel">
				...
				<div class="panel-body">
					...
					<!-- <div class="form-group">
						...
						<div class="col-lg-7">
							<select class="form-control demo-select2-placeholder" name="manage_type_id" id="managed_id" required>
								...
								<option value="0">Ecom</option>
								<option value="1">Ekhadi</option>
							</select>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-lg-7">
							<input type="text" class="form-control" id="tags" name="tags[]" placeholder="{{ translate('Type to add a tag') }}" data-role="tagsinput">
						</div>
					...
					<div class="form-group">
						...
						<div class="col-lg-7">
							<input type="text" class="form-control" id="json_tags" name="jsontags[]" placeholder="{{ translate('Type to add a tag') }}" data-role="tagsinput">
						</div>
						<button id="copy" type="button" title="Copy json tags"><i class="fa fa-copy"></i></button>
							<div id="copy_tags"></div>
					</div>
						<div class="form-group">
						<label class="col-lg-2 control-label">HSN Code *</label>
						<div class="col-lg-7">
							<input type="text" placeholder="HSN Code" name="hsn_code" class="form-control" required>
						</div>
					</div>
					...
					<!-- <div class="form-group">
						...
						<div class="col-lg-7">
							<input type="checkbox" name="gift_card" value="1">
						</div>
					</div> -->
			...
			<div class="panel">
				...
				<div class="panel-body">
					...
					{{-- <div class="form-group">
						...
						<div class="col-lg-7">
							<input type="number" min="0.01" value="0" step="0.01" placeholder="{{ translate('Unit price') }}" name="unit_price" class="form-control" required>
						</div>
					</div> --}}
					<div class="form-group">
						<label class="col-lg-2 control-label">{{translate('Purchase price')}}</label>
						<div class="col-lg-7">
							<input type="number" min="0.01" value="0" step="0.01" placeholder="{{ translate('Purchase price') }}" name="purchase_price" class="form-control" required>
						</div>
					</div>
					<div class="form-group">
