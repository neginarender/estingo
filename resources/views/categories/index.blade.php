        ...
        <table class="table table-striped res-table mar-no" cellspacing="0" width="100%">
            <thead>
                <tr>
                    ...
                    <th>{{translate('Download Products')}}</th>
                </tr>
            </thead>
            <tbody>
                @foreach($categories as $key => $category)
                    <tr>
                        ...
                        <td>
                        <a href="{{route('categories.download', encrypt($category->id))}}">
                            <button class="btn btn-primary dropdown-toggle dropdown-toggle-icon" type="button">
