...
@endif
@if(in_array(Auth::user()->user_type, ['admin', 'cluster_hub', 'sorting_hub']) || in_array('1', json_decode(Auth::user()->staff->role->permissions)))
<div class="row">
    <div class="col-md-6">
        <div class="panel">
...
@if((in_array(Auth::user()->user_type, ['admin', 'cluster_hub', 'sorting_hub']) || in_array('5', json_decode(Auth::user()->staff->role->permissions))) && \App\BusinessSetting::where('type', 'vendor_system_activation')->first()->value == 1)
    <div class="row">
    <div class="col-md-4">
        <div class="panel">
            <div class="panel-body text-center dash-widget dash-widget-left">
                ...
                <div class="table-responsive">
                    <table class="table table-striped mar-no">
                        ...
                        <tbody>
                            @foreach (\App\Category::where('featured',1)->get() as $key => $category)
                                @php
                                    $products = \App\Product::where(['category_id'=>$category->id,'published'=>1])->count();
                                    $qty = 0;
...
@if(in_array(Auth::user()->user_type, ['admin', 'cluster_hub', 'sorting_hub']) || in_array('9', json_decode(Auth::user()->staff->role->permissions)))
    <div class="row">
    <div class="col-md-6">
        <div class="panel">
...
@if(in_array(Auth::user()->user_type, ['admin', 'cluster_hub', 'sorting_hub']) || in_array('8', json_decode(Auth::user()->staff->role->permissions)))
    <div class="flex-row">
