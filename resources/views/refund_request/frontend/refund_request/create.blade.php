            ...
            <div class="row cols-xs-space cols-sm-space cols-md-space">
                ...
                <div class="col-lg-9">
                    <div class="main-content">
                        ...
                        <form class="" action="{{route('purchase_history.refund_request_sends', $order_detail->id)}}" method="POST" enctype="multipart/form-data" id="choice_form">
                            @csrf
                            <div class="form-box bg-white mt-4">
                                <div class="form-box-content p-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <?php $refund_amount = ($order_detail->price-$order_detail->peer_discount);?>
                                        <div class="col-md-10">
                                            <input type="number" class="form-control mb-3" name="name" placeholder="{{__('Product Price')}}" value="{{ $refund_amount }}" readonly>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                            ...
                            <div class="form-box mt-4 text-right">
                                <button type="submit" class="btn btn-styled btn-base-1">{{ __('Refund') }}</button>
                            </div>
                        </form>
                    </div>
                </div>
